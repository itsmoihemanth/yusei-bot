...
async def tic(ctx: discord.ApplicationContext):
...
async def ask(ctx: commands.Context):
    ...
    print(view)
    print(view.value)
    print(view.confirm_callback.style)
...
bot.run("OTMwNDA1ODI5MTEzNDE3NzU4.Gk-SKd.dvhxxTG3CEqWAa_dqm4DrYBiaB3q7mL3HLycCo")